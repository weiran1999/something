...
def sign_in():
    ...
    time.sleep(10)#必要的等待加载
    browser.find_element_by_css_selector("#app > div > div.sign-in-box > button.sign-in-btn.go-sign-btn.van-button.van-button--info.van-button--normal").click()
